        ...
        <div id={props.id}>
            <div className="hero min-h-screen bg-[url('../../assets/images/problem-statement-web.jpg')] ">
                ...
                <div className="hero-content flex-col lg:flex-row-reverse text-neutral-content">
                    ...
                    <Link href="#approach"><button className="btn bg-transparent text-white hover:-translate-y-1 hover:scale-110 duration-300 hover:bg-transparent">How we help you</button></Link>
                    </div>
                </div>
            </div>
        </div>
