            ...
            <div className="hero min-h-screen">
                <div className="hero-content flex flex-col lg:flex-row lg:items-center">
                    <div className="hidden lg:block lg:ml-10 space-y-2">
                        <img src="/images/ntp.JPG" className="max-w-lg rounded-lg shadow-2xl" alt="Consulting Biz Co-Founders" />
                        <p className="text-center text-sm">Consulting Biz Co-Founders Ibrahim (left) and Rohan (middle) winning the 2018 YMCA Peace Prize</p>
                    </div>
                    <div className="text-center lg:text-right w-full">
                        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-3">Our Mission</h1>
                        <div className='py-6'>
                            <h1 className="text-2xl md:text-3xl mb-5">At Consulting Biz, our mission is clear: <div><b>We're here to pave the way for you to get recruited by your dream school.</b></div></h1>
